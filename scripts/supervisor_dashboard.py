...
<div class="scroll"><table><thead><tr><th>Status</th><th>Operation</th><th>Filter / diagnosis</th><th>Duration</th><th>Completed</th><th>Exit</th><th>Run/request</th></tr></thead><tbody id="runs"></tbody></table></div></div>
