...
create_label "risk:end-to-end" "5319E7" "Hardest end-to-end execution; defaults to GPT-6 Sol / high; Astra requires explicit escalation"
...
create_label "authoring:scene-existing-composition" "0E8A16" "Permits human-approved bounded environmental composition in one exact existing scene"
