...
grep -q 'authoring:scene-existing-composition' "$ROOT/scripts/install-labels.sh"
...
grep -q 'authoring_tier="existing-scene-composition"' "$ROOT/scripts/unity-resource-guard.sh"
...
grep -q 'existing-scene-composition' "$ROOT/scripts/windows/run-unity-authoring.ps1"
...
grep -q 'generatedNavigationAssets' "$ROOT/scripts/windows/run-unity-authoring.ps1"
grep -q 'generatedCopyBackAssets' "$ROOT/scripts/windows/run-unity-authoring.ps1"
